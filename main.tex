...
\title[short title]{Algoritmo de fusion sensórica en FPGA } % The short title appears at the bottom of every slide, the full title is only on the title page
\subtitle{Sistema embedido y esquema de control}

\author[Morales]{Andrés Morales Martínez}
\institute[KYMA UN]{Grupo de Investigación KYMA UN \newline Facultad de Ingeniería \newline Universidad Nacional de Colombia}
